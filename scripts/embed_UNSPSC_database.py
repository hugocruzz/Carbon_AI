...
# Load the DataFrame
df = pd.read_excel('data/achats_EPFL/Tableau UNSPSC V10 Full_Raw_1 (006).xlsx')
embedding_column_name = "English Name"
output_file_name = 'data/achats_EPFL/unspsc_ada_embeddings.pkl'
